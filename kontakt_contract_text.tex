...
Der Veranstalter organisiert an der ETH Zürich jährlich eine zweitägige Kontaktmesse mit dem Ziel Studierende der ETH mit Schwerpunkt in den Studiengängen Maschinenbau, Elektrotechnik und Wirtschaft, mit den Firmen in Kontakt zu bringen. 
...
\begin{enumerate}
	...
	\item Inserat- und Paketoptionen (\S\ref{options})
